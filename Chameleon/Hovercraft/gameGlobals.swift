...
class GameGlobals {
    ...
    init() {
        levels = [
            ...
            "BlackWithObstacles" : Level(bitmapName: "BlackWithObstacles.png", size: CGSizeMake(7000, 7000), startingPoint: CGPointMake(385, 471), backgroundColor: UIColor(red: 0x0b / 255, green: 0x0b / 255, blue: 0x0b / 255, alpha: 1)),
        ...
        chars = [
            ...
            "chubbieBoy" : Char(firstBitmapName: "chubbieBoy1.png", secondBitmapName: "chubbieBoy2.png", thirdBitmapName: "chubbieBoy3.png", fourthBitmapName: "chubbieBoy4.png", distanceFromStartPoint: 15, size: CGSizeMake(51, 72), timePerFrame: 0.125),
