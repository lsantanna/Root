...
class GameGlobals {
    ...
    init() {
        levels = [
            ...
            "BlackWithObstacles" : Level(bitmapName: "BlackWithObstacles.png", size: CGSizeMake(7000, 7000), startingPoint: CGPointMake(385, 471), backgroundColor: UIColor(red: 0x0a / 255, green: 0x0a / 255, blue: 0x0a / 255, alpha: 1)),
